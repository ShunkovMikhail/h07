...
exports.postsRouter.post('/:id/comments', auth_middleware_1.authMiddleware, inputValidation_1.CommentVdChain, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = (0, express_validator_1.validationResult)(req);
